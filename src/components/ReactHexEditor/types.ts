...
import { Align, ListOnItemsRenderedProps } from "react-window";
...
export type EditModeType = typeof EDIT_MODE_ASCII | typeof EDIT_MODE_HEX;
...
export interface RenderByteProps {
  offset: number;
  value: number | null;
...
export interface BaseHexEditorProps {
  ...
  onSelectionChanged?: (props: SelectionChangedProps) => void;
